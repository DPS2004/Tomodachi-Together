...
local option_x1 = slashtools.number('x1', 'X coordinate, from 0 to 100')
option_x1:setRequired(true)
option_x1:setMinValue(0)
option_x1:setMaxValue(100)
command:addOption(option_x1)
local option_y1 = slashtools.number('y1', 'Y coordinate, from 0 to 100')
option_y1:setRequired(true)
option_y1:setMinValue(0)
option_y1:setMaxValue(100)
command:addOption(option_y1)
local option_x2 = slashtools.number('x2', 'X coordinate, from 0 to 100')
option_x2:setRequired(true)
option_x2:setMinValue(0)
option_x2:setMaxValue(100)
command:addOption(option_x2)
local option_y2 = slashtools.number('y2', 'Y coordinate, from 0 to 100')
option_y2:setRequired(true)
option_y2:setMinValue(0)
option_y2:setMaxValue(100)
