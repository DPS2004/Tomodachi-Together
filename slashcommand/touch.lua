...
local option_x = slashtools.number('x', 'X coordinate, from 0 to 100')
option_x:setRequired(true)
option_x:setMinValue(0)
option_x:setMaxValue(100)
command:addOption(option_x)
local option_y = slashtools.number('y', 'Y coordinate, from 0 to 100')
option_y:setRequired(true)
option_y:setMinValue(0)
option_y:setMaxValue(100)
...
local function rfunc(interaction, command, args, user, channel)
	citrainput:touch(args.x/100,args.y/100)
